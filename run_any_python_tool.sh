...
usage() {
    ...
    echo "    doc_generator_enhanced.py - AST-integrated documentation with interactive HTML & 6-tab navigation (NEW)"
    echo ""
    ...
    echo "  $0 data_flow_tracker_v2.py --var config --show-impact --file app.py  # Show impact of changing a variable"
    echo "  $0 data_flow_tracker_v2.py --var price --show-calculation-path --file calc.py  # Show how value is calculated"
    echo "  $0 data_flow_tracker_v2.py --var data --track-state --file process.py  # Track type and state changes"
    echo "  $0 doc_generator.py --function calculate --file module.py --style api-docs  # Rich production documentation"
    echo "  $0 doc_generator.py --class MyClass --file MyClass.java --style user-guide --depth deep  # User-friendly guide"
    echo "  $0 doc_generator_enhanced.py --class MyClass --file MyClass.java --format interactive  # Interactive HTML with tabs"
