...
"""
Refactor Rename Tool (v2) - Code-aware file and symbol renaming with undo support.

This version adds SafeGIT-style multi-level undo capabilities to all rename operations.
Every file modification is tracked with atomic operations and full recovery support.
        ...
        try:
            ...
            if changes > 0:
                if not self.dry_run:
                    ...
                    if HAS_UNDO_SYSTEM and _undo_enabled:
                        try:
                        ...
                        try:
                            ...
                            if file_key not in _operations_tracked:
                                ...
                                if _undo_description:
                                    ...
                                    description = f"Replace text in {file_path.name}"
...
def main():
    ...
    if HAS_UNDO_SYSTEM and _operations_tracked and not args.dry_run:
        print(f"\n✅ Tracked {len(_operations_tracked)} rename operation(s) with undo support.")
